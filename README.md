...
| 📄 **[function.md](function.md)** | `dbo.PF_LOTHIST_HISTORY3` | `Scalar UDF` | Historical lot comment decoding engine with 60+ transaction history codes, positional parsing rules, and performance optimization details. |
